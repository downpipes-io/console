#!/usr/bin/env bash
# Generate a CycloneDX 1.6 SBOM for the console repo (runtime deps only).
#
...
#
# See engine/docs/security/sbom.md for the dependency inventory. The
# @noble/* crypto dependencies are exact-pinned in package.json (no caret
# range), which is the secure posture for cryptographic libraries.
