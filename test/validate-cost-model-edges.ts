...
export function run(h: Harness): void {
  ...
  // never Infinity. base has positive churn (dA = 0.5e9) and runs (f = 30), so computing it via
  // storedBytesAccumulate at +Infinity would return Infinity and propagate NaN/Infinity to
  // callers. The finite snapshot is the current size A0.
