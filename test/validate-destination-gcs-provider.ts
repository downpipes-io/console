// TC-destination-gcs-provider: the Google Cloud provider hides what it cannot honour, and never SENDS it.
//
...
//
// IMMUTABILITY IS NOT ONE OF THEM, and this file said it was until. Measured against a real
...
console.log("TC-destination-gcs-provider: Google Cloud hides and never submits the fields it cannot honour");
...
console.log("\n-- the rendered form --");
{
  ...
  // It was "hidden: GCS has no S3 Object Lock" until, which was false: measured against a real
