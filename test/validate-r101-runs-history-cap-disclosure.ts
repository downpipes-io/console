// TC-r101-runs-history-cap-disclosure: the Runs summary band must disclose the bound on the ring
// its totals are drawn from. Run with: node test/validate-r101-runs-history-cap-disclosure.ts
//
...
console.log("TC-r101-runs-history-cap-disclosure: the ring bound is stated on the Runs screen");
