// TC-restore-apply-deadline: the plan screen must render the engine's applyDeadline honestly, and must not
// invent one when the engine did not send it. Run with:
