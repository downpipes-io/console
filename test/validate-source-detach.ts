// RG3 (detach half): the one-shot-token detach on the Sources screen, driven through the REAL
...
// the shape isUnauthorised keys on. (Learned the hard way in RG9, where a status property was ignored
// and the wrong branch ran.)
