// R-15 (B6 follow-on): a restore that crosses into TWO OR MORE distinct foreign Cloudflare accounts must
...
console.log("R-15: the cross-account type-to-confirm must bind EVERY distinct foreign account, not just the first");
