...
// and the custom-role model + resolution helpers it composes over (src/lib/identity.ts), build-contract
// section 1 (composable custom roles). Run with: node test/validate-roles-builder.ts
//
