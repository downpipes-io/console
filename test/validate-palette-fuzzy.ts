// Validate the command-palette fuzzy scorer (finding console-src-028-18: fuzzyScore runs on
// every keystroke over the whole registry but had no test that asserts directly on its score,
// ranking order, or null-for-non-subsequence behaviour). Run with:
