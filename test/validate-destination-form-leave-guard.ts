// TC-destination-form-leave-guard: the destination form must not lose an unsaved secret access key to an
...
console.log("TC-destination-form-leave-guard: an unsaved secret access key survives a navigation");
