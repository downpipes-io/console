// Cost estimator: the multi-destination MARGINAL-COST asymmetry (D1, customer-facing accuracy). The multi-
// destination estimator (shipped this session) sums STORAGE, WRITE and per-run cost across the 3-2-1 fan-out
