// TC-r104-costs-manual-mode-honesty: the Cloudflare-resources card must not claim a figure is
// "measured from your run history" once the operator has switched to Manual mode and is pricing a
// hypothetical scenario. Run with: node test/validate-r104-costs-manual-mode-honesty.ts
//
...
console.log("TC-r104-costs-manual-mode-honesty: the platform card's 'measured' claim tracks the active mode");
