...
// the calm note and posture strip (design-system.md 6.21, 6.22, CALM-04). These cover three of the
...
// The strip has no trailing detail affordance (see src/components/feedback.ts for why), so the
// assertion below is that NO link-like button is built for any input, not that one is built for
// the right one.
