...
//     entry of their own, must classify oppositely ("beyond-ring" vs "empty") -- this is the exact
//     boundary-day misclassification this test pins down.
...
function main(): void {
  ...
  // ========================================================================
  {
    ...
    // is exactly the misclassification that a boundary check needs to catch.
