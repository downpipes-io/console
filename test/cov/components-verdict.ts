// Coverage for src/components/verdict.ts: the expanded TRUST / VERDICT surface (design-system.md
// 6.8 / 6.23, access-security-model.md 1.3/1.4). It renders the full Access
...
// chain-verify result, a connection probe). The crux it must honour is this rule: the Access
