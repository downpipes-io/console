...
function summaryPhraseTests(): void {
  ...
  // The no-copy clause reads differently from partial: a partial copy is behind, a no-copy
  // destination has stayed empty, and the phrase is what an operator scanning the map summary
  // sees first.
