// TC-dest-r2-other-account: an R2 destination must be pointable at an account OTHER than the engine's,
...
async function main(): Promise<void> {
  ...
  // and detaching a focused control drops the caret to the body. Measured in chromium before the fix, a
  // 32-character id typed into the field left it holding "9" with document.activeElement on BODY. Every
