...
//       instead (console-src-054-02's "all ticked -> compact auto form" invariant re-expressed here:
//       the account-and-zone preset must still send the compact include:[] + cfConfigMode:auto form,
//       never a redundant full id list).
//
