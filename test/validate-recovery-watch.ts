// G-P0-096 regression cover: THE CONSOLE MUST NOTICE A LATCH RAISED WHILE THE TAB IS OPEN.
//
...
// watch. Measured on the committed bundle in real Chromium (latched harness-genesis): one
// status read at t+0.1s (401), none for the next 45s while whoami re-resolved to owner at t+4.1s, and the
