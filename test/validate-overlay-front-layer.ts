...
//
//   1. the marked elements (persona-fork's welcome card, nav-bar, training intro -- the three the
//      owner named) really carry data-front-layer once mounted, under the REAL production code, and
