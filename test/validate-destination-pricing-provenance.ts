// TC-destination-pricing-provenance: the destination form must say WHOSE list prices it prefilled.
...
console.log("TC-destination-pricing-provenance: the prefilled rates name the vendor they came from");
