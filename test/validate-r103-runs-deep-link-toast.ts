// TC-r103-runs-deep-link-toast: a dangling deep link to a run must say why it fell back to the
// list, matching the toast sources-downpipes.ts already gives for the equivalent dangling-id
// fallback there. Run with: node test/validate-r103-runs-deep-link-toast.ts
//
...
console.log("TC-r103-runs-deep-link-toast: a dangling run deep link explains its fallback");
