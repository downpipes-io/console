// P4.2 (the GUI quality pass, judged against the P1.8 verdict vocabulary): a failed SECTION read must
// leave a way back.
//
...
// only refuses the EMPTY state passes on an error banner, and that exact shape shipped in this workspace
...
// the visible label is copy and may be reworded, the hook is the contract the harness drives.
...
async function main(): Promise<void> {
  ...
  // the density the calm budget (design-system.md 7a) rules out.
  //
