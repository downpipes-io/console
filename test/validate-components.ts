...
//
// Gap audit reference: downpipes-AUDIT.md, CON-H11, CON-M12, CON-L3, CON-L4, CON-L21.
...
async function main(): Promise<void> {
  ...
  verdictReached(state.failures); // the verdict is now DECLARED, so a silent exit 0 cannot pass as green
