// INFRA-1 control-plane recovery — the console face of the engine's silence-killer. Validates the PURE
...
async function main(): Promise<void> {
  ...
  // ---- R-81: recoveryBannerModel carries the auto-heal's staged summary ---------------------------
  console.log("\n-- recoveryBannerModel: staged (R-81) --");
  ...
  try {
    ...
    // ---- R-81: controlPlaneApplyStaged (client) --------------------------------------------------
    console.log("\n-- controlPlaneApplyStaged (R-81, fetch-stubbed) --");
  ...
  // R-81: a SEALED export pasted into the manual reconcile form is refused with the TRUE cause (a format
  ...
  // ---- R-81: _testRunApplyStaged (the auto-heal confirm pipeline) ---------------------------------
