// Validate the pure logic of the offline break-glass custody experience
// (ENTERPRISE-UX-BLUEPRINT section 7.3): the scheme model, the M-of-N parameter rules, the
