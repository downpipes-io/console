...
// ---------------------------------------------------------------------------
// 3b. TOML-injection guard (finding console-src-009-02): an identifier carrying a
...
// Direct quote/backslash injection (finding console-src-009-04): wranglerStanza performs no
...
if (existsSync(engineSchedDir)) {
  ...
  //
  // CANNOT CHECK, AND A REQUIRE ARM THAT DID NOT EXIST. This file had neither. Driven at console 7bf0734b
  // in a checkout with no sibling engine it exited 0 with REQUIRE_ENGINE=1 exactly as it did without,
  ...
  if (process.env.REQUIRE_ENGINE === "1") {
    verdictCannotCheck(
      "validate-add-source: REFUSED, REQUIRE_ENGINE=1 and no engine checkout is reachable.\n" +
