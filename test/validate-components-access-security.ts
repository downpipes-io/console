...
// Source-IP cell distinction. Extracted from validate-components.ts (finding
// console-test-003-01) with no change to any assertion.
//
// Gap audit reference: downpipes-AUDIT.md, CON-L3, CON-L4.
...
// ===========================================================================
// 9. ACCESS-SECURITY ENGINE-STATE FIELD LABELS (CON-L4)
// ===========================================================================
...
console.log("\n-- access-security: engine-state field label mapping (CON-L4) --");
...
// ===========================================================================
// 10. ACCESS-SECURITY HEALTH-PROBE REPAINT LOGIC (CON-L3)
// ===========================================================================
...
// A repaint on success is the redundant-repaint bug described in CON-L3.

console.log("\n-- access-security: health probe no-redundant-repaint (CON-L3) --");
