...
async function main(): Promise<void> {
  ...
  //
  // The engine half of defect 50 landed: GET /history now publishes runsRecordedTotal,
  // runsRetainedCount, runsRolledOverCount and runlogCounterReset beside the rings. The console read only
