// The external-link warning interstitial, split out of the app entry (app.ts)
...
// FIRST_PARTY_HOSTS: hosts the warning does NOT apply to. The warning is about a link leaving the
...
// installExternalLinkInterstitial adds the EXTERNAL-LINK WARNING: a delegated click handler
