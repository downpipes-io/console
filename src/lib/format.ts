...
// request. Numbers use grouping; bytes use binary units; times render as a relative phrase plus an
// absolute title. None of these values is ever sent back to the engine.
...
// hides any blackout window. Show the cron with its zone when present, else the cadence label; note a
...
// throwing on .length and blanking the whole overview.
