// The bounded next-fire preview. It computes the next few wall-clock fire times of a cron in a
// timezone, mirroring the engine's minute-walk, for a calm UI preview. The engine remains
// authoritative; this is a small client-side estimate.
