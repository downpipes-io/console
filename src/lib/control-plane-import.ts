// The "recover an estate from a signed export" flow (the recovery keystone's console face). A bootstrapped
...
//
// Each rejection carries a STABLE REFUSAL CODE, stamped into the message the operator reads. These
