...
// (ENTERPRISE-UX-BLUEPRINT section 7.3). This is the load-bearing core the validator
...
// tiers mirror the blueprint menu (7.3); "undecided" is the honest default before a
...
export interface SchemeOption {
  ...
  detail: string; // the concrete, copy-ready guidance (blueprint 7.3 wording)
...
// QR_MAX_BYTES is the conservative single-QR capacity used for the count (blueprint 7.3).
