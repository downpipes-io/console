...
// only, since without that override an animated surface such as the map would
// stay frozen under a reduced-motion OS setting with no way to turn it back on).
