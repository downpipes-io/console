...
// Free functions over the shared Transport, mirroring client-push.ts, the SIEM audit-log push sibling.
//
...
// the Clear control collects one and discards it, since /otlp-push/delete does not yet reach the engine's
// enforceChangeControl chokepoint, so nothing records it there either.
