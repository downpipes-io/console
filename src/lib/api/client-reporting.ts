// Reporting domain functions for the EngineClient: signed, tamper-evident reports, the compliance
// evidence packs, and the RTO estimate. Free functions over the shared Transport.
//
...
// Access-redirect body is named honestly rather than read as a corrupt PDF. The bytes are
