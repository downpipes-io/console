// Canary-backup domain functions for the EngineClient: free functions over the shared
// Transport, each building the request URL, method, body and headers and parsing the response.
//
// Alert delivery is configured through notify channels and rules (client-notifications.ts, rendered by
