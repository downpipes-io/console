...
// an Access-redirect body is named honestly rather than read as a corrupt download.
//
...
// inside the seal and the signature. Passing it turns the download into a POST; the
