// Native external-IdP SSO mirror types. See ../types.ts for the barrel.
...
// no presetId lookup at all, so a preset payload without it fails the pre-save probe with "Unknown
// connection kind" (engine/src/admin/idp-test.ts).
