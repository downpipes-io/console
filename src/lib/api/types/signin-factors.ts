...
//
// WHY THE CONSOLE NEEDS THIS AT ALL. The engine closes every way a named person signs in as one audited
// act. The portal must complete every customer action itself, including this security-critical half of an
// offboarding, rather than leaving it to an administrator with a terminal.
//
