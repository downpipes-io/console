// Config version-history mirror types. See ../types.ts for the barrel. These mirror the engine's
// read-only config-history surface (engine
...
// its verdict rides on this body: a history whose head was deleted must never render as "Chain verified".
