// The three-way theme control (design-system.md 4.1 / 10): System / Light / Dark,
// persisted to localStorage under "dp-theme". Obsidian (dark) is the default skin
// when the preference is unset; the pre-paint inline script in index.html applies
// that default before first paint to avoid a flash, and THIS module is the runtime
// control that keeps the same contract.
//
