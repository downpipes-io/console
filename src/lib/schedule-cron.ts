// The 5-field cron grammar parser: the console's CLIENT-SIDE mirror of the engine's cron.ts
// parseField/parseCron. The SAME 5-field grammar, the SAME Vixie dom/dow union rule, the SAME bounds +
// messages. It is a deliberate small re-implementation of the engine's PUBLIC SEMANTICS for a pre-flight
// + a preview; the engine remains the authority and re-validates on save.
