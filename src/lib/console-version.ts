...
// actually served leaves no evidence anywhere: the check can only ever say "not confirmed", and "not confirmed"
...
// without it those tickets are indistinguishable from a console defect.
//
