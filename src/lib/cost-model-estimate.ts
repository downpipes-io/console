...
// ---------------------------------------------------------------------------
// Storage over time: the two regimes (spec section 2.1)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Cost breakdown (spec section 2.2)
// ---------------------------------------------------------------------------
...
// and the total) for the chosen regime, implementing spec section 2.2 exactly.
//
...
export function monthlyCost(inputs: Inputs, pricing: Pricing, opts: MonthlyCostOptions): CostBreakdown {
  ...
  // figure A0 x (1 - c)^R. The spec section 2.2 simplifies this term to A0 (= S x d), which
...
// ---------------------------------------------------------------------------
// Projection over months (spec section 2.3)
// ---------------------------------------------------------------------------
