// Shamir Secret Sharing over GF(2^8), for the offline break-glass custody experience. It splits a
// 32-byte (256-bit) AES WRAPPING key M-of-N among custodians; it is NEVER used on the 96-byte break-glass
