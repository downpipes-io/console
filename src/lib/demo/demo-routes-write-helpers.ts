// The write handlers' small shared helpers used by demo-routes-write.ts: these five are helpers the
// handlers call, not handlers themselves, and none of them touches a route directly.
