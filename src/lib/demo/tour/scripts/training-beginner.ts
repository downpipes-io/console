...
// whole stage, because the narration answers "why am I doing this" only if the learner reads every beat in
// order and remembers them; the goal answers it at any moment.
//
