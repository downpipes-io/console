...
// marker every edge references. No-custody is never weakened: every server-supplied string
// reaches the DOM through svgText (textContent), so there is no markup-injection surface.
