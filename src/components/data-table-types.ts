...
// the whole machine (data-table.ts re-exports every one of these by name, so the public
...
// A column declaration (design-system.md 6.9: { key, header, render, sortable, align,
...
export interface DataTableOptions<Row> {
  ...
  // the query string (design-system.md 6.9: active filters are deep-linkable). The
  ...
  // plus overscan. Default 150 (design-system.md 6.9).
