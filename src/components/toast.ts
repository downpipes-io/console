// The toast region (design-system.md 6.12, information-architecture.md 2.6). A
...
// rule that keeps the two-channel error model clean (build-contract 2.4).
//
...
// tokens.css). No native alert() is used anywhere in the console; every
// confirmation goes through this toast region.
...
export interface ToastOptions {
  ...
  // fake undo (design-system.md 6.12).
...
export function toast(opts: ToastOptions): () => void {
  ...
  // Pause on hover/focus, resume on leave/blur (design-system.md 6.12).
