// Stat tiles (design-system.md 6.7, the Overview composite 7). A tile is the
...
//
// A11y (6.7): the label and the value are programmatically associated (the value's
...
export interface StatTileOptions {
  ...
  // label (design-system.md 6.8). Use this when the tile encodes health.
