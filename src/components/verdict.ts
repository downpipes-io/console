// The TRUST / VERDICT surface (design-system.md 6.8 / 6.23, access-security-model.md
// 1.3/1.4, build-contract Part 3). The expanded companion to the
...
//
// The same disqualifying rule holds here as in the chip: the Access
...
// the ACCESS verdict (a green Access badge that is not actually verified would misstate
// the customer's security posture); a non-Access verdict surface (audit chain) may use "ok" via verdictSurface.
...
//
// _testPresentAccessTone is exported for the test suite so the
