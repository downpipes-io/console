// The source-to-destination TOPOLOGY MAP (topology-map/spec.md; design-system.md 6.20
// for the inline-SVG idiom; information-architecture.md for the accessible-first rule).
// The visual centrepiece of the console: a bipartite flow map with SOURCES on the left,
