// A small, typed table primitive (design-system.md 6.9). Not the full
...
// markup-injection surface (current-state.md 4).
...
export function table<Row>(opts: TableOptions<Row>): HTMLElement {
  ...
  // rather than blowing out the grid (design-system.md 6.9). When rows are NOT
