// Wizard / stepper (design-system.md 6.18). The full-bleed, centred, single-track flow
...
// the current step.
//
// A11y (6.18 / 8): the stepper is an ordered list (<ol>) with the current step marked
