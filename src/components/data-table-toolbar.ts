...
// as a dependency-light sibling so the component module stays under the size budget; each
// function reads the live table state and callbacks through the shared ctx object rather
// than a closure.
