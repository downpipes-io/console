...
// Esc, click-out). The drawer is DEEP-LINKABLE (design-system.md 6.11): the caller
// reflects the selected entity in the URL when opening and returns to the list URL
// on close, restoring the back-button and shareability the router-less console
// lacked (current-state.md U1). On Compact it presents as a bottom sheet (the CSS
...
// h2 title) so the document outline stays valid (design-system.md 8).
