...
// belt-and-braces style guard below.
//
// A11y (design-system.md 6.2 / 8): role="dialog" aria-modal with an accessible name;
...
// the @media (max-width: 767px) palette compact rule) lives in section 14
// of public/tokens.css, the design-system authority for all component
