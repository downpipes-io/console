...
export interface OpenPaletteOptions {
  ...
  // assembles: allScreenActions(SCREENS) folded into the static COMMANDS (build-contract
  // 2.1). The palette still applies the role + engine-state `when` gate to whatever it
