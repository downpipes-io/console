// Settings: engine connection (custom domain only, with the
...
// offboarding and demo sections in ./settings/sections.ts. The public surface these modules present stays
// stable regardless of which file backs it.
...
export { vendorSealPresentation, supportGrantPresentation, latestPullAt, supportBundleFileName, emailTestVerdict, accessPerimeterNote, metricsEndpointNote, downloadJsonText, pullFreshnessSentence, gapServedBannerMessage } from "./settings/support.ts";
  ...
  render() {
    ...
    return screenScaffold(
      ...
      h(
        ...
        // The SIEM audit-log push, the OTLP metrics push and the SIEM/metrics PULL credentials live on the
        ...
        // No danger tone: the body is guidance plus a role hand-off and a plain sign out, nothing
        // destructive that would warrant one.
