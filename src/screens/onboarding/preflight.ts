...
// headline verdict. These are leaf functions with no DOM and no sibling imports, kept in their own
// module to stay under the size budget, with the public surface byte-identical; the coordinator
// re-exports them so external callers (the support validator) import them unchanged.
