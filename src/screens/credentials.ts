// Credential lifecycle registry: the account's own list of credentials, keys, licences, certificates and TOKENS, each with
...
//   - Calm density (design-system.md 7a): ONE at-a-glance band, the "Needs attention" tier and the
...
// ./credentials/list.ts; the add/edit, cleanup-attest and remove flows in ./credentials/forms.ts.
//
