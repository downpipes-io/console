// Command palette + keyboard layer (design-system.md 6.2, information-architecture.md
// 2.4, build-contract Part 2.3 "command palette"). This is the keyboard spine of the
...
// the keycap renderer and the fuzzy matcher in ./command-palette/shared.ts.
