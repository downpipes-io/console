...
// editor. See ./editor.ts for the barrel.
...
export function buildSchedulePresets(
  ...
  // container's flex gap applies between icon and sentence only. Splitting the sentence into
  // separate text nodes would make each one its own flex item and double the gaps around the strong.
