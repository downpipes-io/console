// SourceSpec assembly for the upsert editor submit path. See ./editor.ts for the barrel.
...
// inline error (with an optional field to focus / a flag for the form-level error), so the caller
// keeps owning the DOM error elements.
