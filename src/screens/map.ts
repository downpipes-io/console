...
// render entry point in ./map/view.ts; this file keeps the public surface stable for external
// callers. The integrator wires the descriptor into the router/palette (we do
...
// this module, so re-exporting them here keeps those imports working. The remaining derivation
