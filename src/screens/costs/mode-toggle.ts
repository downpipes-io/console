...
// It reads host.mode/observedSeed/modeReason and routes a mode change through host.switchMode.
...
export function buildModeToggle(host: CostModeToggleHost): HTMLElement {
  ...
  // Group-level doc link: the two-option radiogroup is one control, so the link that
