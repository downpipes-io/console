...
// make up the panel. The LIVE Cloudflare Zero Trust verifier (reading the REAL whoami
// verdict, never a hardcoded green) lives in ./verifier.ts; the instructional Access
...
// note/badge helpers live in ./shared.ts so this panel never imports a sibling panel.
...
export function renderEnforcementPanel(engine: EngineClient): HTMLElement {
  ...
  // disclosure (design-system.md 7a), the verifier verdict above is the eager
