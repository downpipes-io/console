...
// 401s and sign-out straight to /passkey, so nothing lands here except a stale
// bookmark or a hand-typed deep link. A second sign-in screen here would risk its copy
// drifting from the real one (duplicating the 401-landing role, the framing of auth, and
// the coequal admin-token entry point), so instead this forwards to the one live
