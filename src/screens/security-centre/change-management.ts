...
function loadPolicy(engine: EngineClient, view: ChangeNumberView): void {
  void engine
    ...
    .catch((err) => {
      ...
      // See security-centre/access.ts loadApprovalPolicy: this branch needs its own retry path rather
      // than leaving the switch disabled for the life of the screen with nothing to press.
