...
// (the pure restoreTestRecency helper), so it is never a stale green.
...
// The scheduled-restore-test recency helpers (build contract section 5) live with the
...
// and there is no import cycle (sources-downpipes does not import this screen).
