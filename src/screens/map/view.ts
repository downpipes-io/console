...
// lifecycle controller MapView and its body live in ./controller.ts). The coordinator (../map.ts)
// imports renderMap, screenActions, MAP_ROUTE and the Screen type from here, so the public
