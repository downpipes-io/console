...
// pause, manual Refresh) and the trust telemetry row (the no-custody constant).
...
export function trustRow(): HTMLElement {
  ...
  // area (app-shell renderAccount, its design home per design-system.md 6.23); repeating
  ...
  // product makes. design-system.md 6.15 already forbids this ("triggered on focus as well as hover
  ...
  //
  // The info-tip is the console's existing progressive-disclosure primitive (design-system.md 7a):
  // a real focusable button with role="tooltip" and aria-describedby, opened by focus, click or tap.
  // It carries the SAME STRING, verbatim, so not a word of the owner-blessed copy changes; it only
