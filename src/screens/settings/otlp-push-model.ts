...
//
// This reports the engine's own delivery trail, never claims "guaranteed" delivery.
...
// N", never a total it cannot know, the same discipline push-model.ts's PUSH_TRAIL_MAX follows.
const OTLP_PUSH_TRAIL_MAX = 50;

// The bounded handful of individual attempt lines shown at once (calm-density budget):
// otlpTrailSummary carries the aggregate count; these are a look, never the full history.
