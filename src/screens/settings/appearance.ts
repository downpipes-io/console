...
// Storm adds occasional lightning, and Medium is deliberately the gentlest tier since anything fainter
// is not perceptible. Decorative; honours reduced motion. Returns the element plus an `update` the
