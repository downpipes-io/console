...
// read-only discovery token is their credential. Unlike a bound store, these need an explicit add step
// before they appear in the create-downpipe wizard: this tier is where they are added and removed, so
