// Reports: the signed, tamper-evident
...
// same literal this descriptor uses, rather than a copy that could drift from it unnoticed.
...
export const reportsScreen: Screen = defineScreen({
  ...
  render(_ctx: ScreenContext): HTMLElement {
    ...
    // The standing precise-claims line, stated once for the screen (a quiet
...
function reportCard(engine: EngineClient, meta: ReportMeta): HTMLElement {
  ...
  // surfaced with it. The RTO panel sits AFTER the action
