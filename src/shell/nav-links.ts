// Nav-link construction for the shell rail (design-system.md 6.1): the single source for
...
// Exported for the nav/shell validators (test/validate-nav.ts): they build a REAL rail link and
...
// + label, not colour alone (design-system.md 6.8). A 0/undefined count removes the chip and the
